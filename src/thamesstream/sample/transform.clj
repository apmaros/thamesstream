...
(comment
  ...
  ;; inspect store
  (def view
    (.store st store-name (QueryableStoreTypes/keyValueStore)))
  ...
  (do
    ...
    ;; trigger punctuate
    (clients/send "transaction" "00000009" {:decided-by "Drake" :approve false :published-at (to-long-ts 11 00 10)})
    )
  )
